...
export class MainScene extends Scene {
    ...
    create() {
        ...
        const button2 = this.add
            .rectangle(self.cameras.main.width - 350, 100, 100, 100, 0xff0000)
            .setInteractive()
        this.add.sprite(self.cameras.main.width - 350, 90, "warrior_idle", 0)

        const buttonK2 = this.add
            .rectangle(self.cameras.main.width - 200, 100, 100, 100, 0xff0000)
            .setInteractive()
        this.add.sprite(self.cameras.main.width - 200, 90, "knight_idle", 0)
